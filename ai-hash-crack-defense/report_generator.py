...
BLUE_LIGHT = colors.HexColor("#d4a843")
BLUE_MID   = colors.HexColor("#262626")
...
def make_styles():
    ...
    styles = {
        ...
        "h2": ParagraphStyle(
            ...
            fontSize=12, textColor=colors.HexColor("#262626"),
...
def generate_report(progress_cb=None) -> bytes:
    ...
    axes[2].bar(["Digits","Lowercase","Uppercase","Special"], char_means.values,
                color=["#d4a843","#34d399","#f97316","#a78bfa"], edgecolor="white")
    ...
    story.append(metric_table([
        ...
        ("Avg Unique Chars",f"{df_feats['unique_chars'].mean():.1f}", "#d4a843"),
    ], styles))
    ...
    story.append(section_rule("#262626"))
    story.append(Paragraph(
    ...
    story.append(metric_table([
        ...
        ("Argon2", f"{metrics['argon2_time']*1000:.1f} ms","#d4a843"),
    ], styles))
    ...
    story.append(metric_table([
        ...
        ("Argon2 vs MD5", f"{argon2_ratio:,.0f}× slower", "#d4a843"),
    ...
    clrs   = ["#ef4444","#f97316","#22c55e","#d4a843"]
